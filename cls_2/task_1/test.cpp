...
void test_class_props() {
    ...
    static_assert(!std::is_copy_constructible<int_unique_ptr>::value);

    static_assert(!std::is_copy_assignable<int_unique_ptr>::value);

    static_assert(std::is_move_assignable<int_unique_ptr>::value);

    static_assert(std::is_move_constructible<int_unique_ptr>::value);

    static_assert(std::is_default_constructible<int_unique_ptr>::value);
}
